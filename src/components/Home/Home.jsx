...
const Home = () => {
  return (
    <>
      <div className="d-flex align-items-center justify-content-around flex-wrap text-center mt-3">
      ...
      <div className="d-flex align-items-center justify-content-center flex-wrap  pt-1">
        <a
